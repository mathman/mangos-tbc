        ...
        case SCRIPT_COMMAND_MOVEMENT:                       // 20
        {
            ...
            switch (m_script->movement.movementType)
            {
                ...
                case RANDOM_MOTION_TYPE:
                    if (m_script->data_flags & SCRIPT_FLAG_COMMAND_ADDITIONAL)
                        ((Creature*)pSource)->GetMotionMaster()->MoveRandomAroundPoint(float(m_script->movement.wanderDistance));
                    else
                    {
                        ...
                        ((Creature*)pSource)->GetMotionMaster()->MoveRandomAroundPoint(wander_distance);
                    }
                    break;
